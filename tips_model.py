...
sym_des_path = os.path.join(script_dir, "datasets", "symtoms_df.csv")
precautions_path = os.path.join(script_dir, "datasets", "precautions_df.csv")
workout_path = os.path.join(script_dir, "datasets", "workout_df.csv")
description_path = os.path.join(script_dir, "datasets", "description.csv")
medications_path = os.path.join(script_dir, "datasets", "medications.csv")
diets_path = os.path.join(script_dir, "datasets", "diets.csv")
...
# Load model (assuming svc.pkl is in the same directory as this script)
svc_model_path = os.path.join(script_dir, "svc.pkl")
svc = pickle.load(open(svc_model_path, 'rb'))
...
def helper(dis):
    ...
    pre = [str(item) for sublist in pre for item in sublist if pd.notna(item)] 
...
def run_model(symptoms):
    if symptoms == "Symptoms":
        ...
        # Split and process the symptoms
        ...
        "Suggested Workouts": wrkout
        }

# Example usage
symptoms_input = "itching, joint_pain"
run_model(symptoms_input)